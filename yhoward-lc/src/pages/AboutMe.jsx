  ...
  return (
    <>
      ...
      <div class="flex p-5 absolute top-20 gap-2">
        ...
        <div class="p-5 bg-white opacity-90">
          ...
          <p>
            ...
            <ul>
              Licensed Counselor: I offer a compassionate and understanding
              space to explore your emotions and heal from challenges.
            </ul>
            <ul>
              Educator: I am passionate about guiding you through self-discovery
              exercises and equipping you with tools for lasting change.
            </ul>
            <ul>
              Consultant: I utilize strategic thinking to help you create
              actionable plans and overcome obstacles, ensuring a smooth and
              empowering transition.
            </ul>
            <ul>
              ‘Across the Country’ Resident: I have had the opportunity to call
      ...
      <div class="p-5">
        ...
        <ul>
          Purpose: I genuinely care about your story and success. This is not
          just a job; it’s my passion to see you thrive!
        </ul>
        <ul>
          Proven results: I cultivate and empower individuals to triumph through
          challenging transitions, achieving personal and professional
          fulfillment.
        </ul>
        <ul>
          Compassionate listening: I create a judgment-free space for you to
          share your hopes, fears, and questions without hesitation.
        </ul>
        <ul>
          Tailored approach: I personalize my coaching to your unique needs,
          goals, and learning style.
        </ul>
        <ul>
          Deeply inclusive: I hold a strong commitment to creating a safe and
      ...
      <div className="">
        <h1 class="text-center">
          With Grace, Gratitude, and Goodness, Yvonne Transformative Transition
